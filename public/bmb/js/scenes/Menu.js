class Menu extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('instructions_btn', '/bmb/assets/images/menu_items/instructions.png');
    this.load.image('menu_bg', '/bmb/assets/images/menu_items/menu_bg.png');
    //this.load.image('pvp_btn', '../assets/images/menu_items/pvp.png');
    //this.load.image('pvAI_btn', '../assets/images/menu_items/playerVsAI.png');
    this.load.image('play_btn', '/bmb/assets/images/menu_items/play.png');
    this.load.image('settings_btn', '/bmb/assets/images/menu_items/settings.png');
  }
  init(data) {
