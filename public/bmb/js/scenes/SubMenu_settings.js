class SubMenu_settings extends Phaser.Scene {
  ...
  preload() {
    this.load.image('settings_bg', '/bmb/assets/images/menu_items/settings_bg.png');
    this.load.image('upKey', '/bmb/assets/images/menu_items/upKey.png');
    this.load.image('downKey', '/bmb/assets/images/menu_items/downKey.png');
    this.load.image('leftKey', '/bmb/assets/images/menu_items/leftKey.png');
    this.load.image('rightKey', '/bmb/assets/images/menu_items/rightKey.png');
    this.load.image('detonatorKey', '/bmb/assets/images/menu_items/detonatorKey.png');
    this.load.image('bombKey', '/bmb/assets/images/menu_items/bombKey.png');
  }
  init(data) {
    this.data = data;
    ...
    if (!this.data.isMobile) {
      ...
      this.input.keyboard.on('keyup', (a) => {
        if (this.isAllowedKeyChange) {
          ...
          this.newKeySet[this.selectedKey.keysetId][this.selectedKey.keyId][1] =
            a.keyCode;
